...
function createBoxes(amount) {
    ...
    for (let i = 0; i < amount; i++) {
        ...
        this.appendChild(document.createElement('div')).style = `width: ${widthDiv}px; height: ${heightDiv}px; background-color: 
        rgb(${Math.random(100) * 100}%, ${Math.random(100) * 100}%, 1${Math.random(100) * 100}%);`;
        widthDiv += 10;
        heightDiv += 10;
    }
}
